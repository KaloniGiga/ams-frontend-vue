...
<template>
  <ActionDropdown @editClick="handleEditClick" @deleteClick="handleDeleteClick" v-model="isOpen" :isDeleteClicked="isDeleteClicked">
    <UserDialog :isEdit="true" v-if="!isDeleteClicked" />
    <div v-else-if="isDeleteClicked"></div>
  </ActionDropdown>
</template>
